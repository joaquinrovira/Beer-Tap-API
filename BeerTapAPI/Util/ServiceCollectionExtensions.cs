...
public static class ServiceCollectionExtensions
{
    ...
    public static void AutoRegister<T>(this IServiceCollection collection)
        => AutoRegister(collection, typeof(T).Assembly);
}
...
public class ServiceAttributeProcessor : AssemblyAttrbiuteProcessor<ServiceAttribute>
{
    ...
    public static void Apply(IServiceCollection collection, Assembly assembly, params Assembly[] assemblies)
        => new ServiceAttributeProcessor(collection).Process(assembly, assemblies);
    ...
    {
        typeof(IEquatable<>) // We ignore this interface to simplify registering "record classes" 
    };
